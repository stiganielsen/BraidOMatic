...
public class BraidOMatic2018v2 extends PApplet {
...
public void splashText(String printThis){
  fill(185);
...
public void Splash(String inputString){
  splashVisible=50;
...
print(tracesList.size()+" traces");
 for (int t=0; t<tracesList.size(); t++) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BraidOMatic2018v2" };
    if (passedArgs != null) {
